# GitHub Copilot Instructions for unletter

## Project Overview

Unletter is a Cloudflare Workers app (managed with Alchemy) that converts email newsletters into RSS feeds. Current focus is landing page + waitlist.
...
- **AGENTS.md** — canonical agent instructions (this file mirrors its relevant sections).
- **README.md** — user-facing documentation.
- **docs/ARCHITECTURE.md**, **docs/SETUP.md** — design and deployment docs.

For full detail, see [AGENTS.md](../AGENTS.md).
